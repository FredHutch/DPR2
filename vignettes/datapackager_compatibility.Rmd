...
Notice that the above conversion does do a bit of digest validation, where in the above example, one of the tracked files has a different checksum than what is reported in the digest. 
