...
`dpr_path()` is used to refer to other paths within processing scripts and `dpr_save()` to save objects to the `data` directory. Objects saved this way are saved as single object `rda` files, a requirement for DPR2.
