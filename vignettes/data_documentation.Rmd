...
Since existing documentation files are overwritten when a checksum change is detected, users are encouraged to save any custom edits such as descriptions, source references, or links so they can be copied into the updated version if needed. If data does not change, no documentation will be overwritten.
