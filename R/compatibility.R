...
##' @param path Specifyies the relative path to the data package. The default is the
##'   working directory.
##' @author jmtaylor
...
#' A private function that throws warning when using deprecated [project_path()] wrappers for DPR1
#' compatibility
#' @noRd
